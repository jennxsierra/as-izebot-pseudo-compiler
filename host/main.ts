// CLI host for the iZEBOT pseudo-compiler.
// Responsibilities:
// - Load the compiled AssemblyScript WASM module
// - Present a simple REPL that displays the BNF, accepts input, and
//   invokes the compiler
// - Decode the compiler's single-string response (DERIVATION/TREE/CODE
//   sections) and present/save the results to the user
...
async function initialize() {
  // Load and initialize the WebAssembly module produced by build
...
async function mainLoop() {
  ...
  while (true) {
    ...
    // The compiler returns a single formatted string containing section markers
    // that the host will split and display to the user.
    ...
    try {
      ...
      // Report IO errors; saving is non-fatal for the REPL session
